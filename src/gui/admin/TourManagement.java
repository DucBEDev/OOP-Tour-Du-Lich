...
public class TourManagement extends JPanel {
    ...
    public TourManagement() {
        ...
        AddTourFrame actionListener = new AddTourFrame();
        JButton addTourButton = new JButton("Thêm");
        addTourButton.addActionListener(actionListener);
    ...
    private JPanel createTourRow(Tour tour, int indexInPage) 
    {
        ...
        JLabel durationLabel = new JLabel("Thời gian tour: " + tour.getDuration() + " Ngày " + (tour.getDuration() - 1) + " Đêm ");
